...
export const footerColumns: FooterColumnData[] = [
  ...
  },
  {
    title: 'Help & info',
    items: [
      { type: 'link', label: 'FATrack Your OrderQ', to: '/faq' },
      { type: 'link', label: 'Returns policies', to: '/shipping' },
      { type: 'link', label: 'Shipping + Delivery ', to: '/returns' },
      { type: 'link', label: 'Contact Us', to: `${routeMap.contacts.path}` },
      { type: 'link', label: 'Faqs', to: `/faq` },
    ],
  },
];